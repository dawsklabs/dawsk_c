...
impl<'a> Parser<'a> {
    pub(super) fn parse_var_stmt(&mut self) -> ASTStmt {
        ...
        ASTStmt::var_dec(ident, mutable, ty, expr)
    }

    pub(super) fn parse_const_stmt(&mut self) -> ASTStmt {
        ...
        ASTStmt::const_dec(ident, public, ty, expr)
    }
}